...
## Contents
  ...
  - ### Machine Learning with Python 
   ...
   -  ### Data Cleaning and Preprocessing Projects
       ...
       - [Data Preprocessing Project-Feature Scaling](https://github.com/pb111/Data-Preprocessing-Project-Feature-Scaling/blob/master/Data%20Preprocessing%20Project%20-%20Feature%20Scaling.ipynb): **Feature Scaling** is the process which is used to standardize the range of independent variables so that they can be mapped onto the same scale. This project demonstrates useful techniques related to Feature Scaling.
