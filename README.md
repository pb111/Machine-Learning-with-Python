...
## Contents
  ...
  - ### Machine Learning with Python 
      ...
      - ### Supervised Learning : Classification Projects
          ...
          * [Logistic Regression Project](https://github.com/pb111/Logistic-Regression-in-PythonProject/blob/master/Logistic%20Regression%20with%20Python%20and%20Scikit-Learn.ipynb): In this project, I train a binary classification Logistic Regression model to predict whether or not it will rain tomorrow in Australia. I have used **Rain in Australia** dataset from the Kaggle website. I have demonstrated feature Engineering techniques alongwith **Recursive Feature Elimination with Cross-validation**, **k-fold Cross Validation** and **GridSearch CV** in this project.
